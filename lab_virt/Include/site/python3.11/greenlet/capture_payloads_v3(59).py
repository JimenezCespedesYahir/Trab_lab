...
# ----------
#
# ✅ Eliminado nth() persistente
# ✅ Eliminado índices inestables
# ✅ Remap containers después de rerender
# ✅ Matching semántico estable
# ✅ Filtrado por combobox real
# ✅ Overlay lifecycle robusto
